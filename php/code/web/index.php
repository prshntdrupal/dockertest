...
$callerId        = getenv('PHONEDUTY_CALLER_ID');
...
if ($user !== null) {
    ...
    $twilio->say(sprintf("The current on-call engineer is %s." .
        ...
        $user['full_name'], $time), $attributes);

    $dial = $twilio->dial(NULL, array('callerId' => $callerId,'action' => "check_if_completed_by_human.php", 'timeout' => 25));
